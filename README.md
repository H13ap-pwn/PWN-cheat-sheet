...
- `Free` 2 lần 1 chunk khiến `forward pointer` của nó tự trỏ nó (lưu ý trước khi free lần 2 cần đổi key) sau đó overwrite `forward pointer` thành target address
